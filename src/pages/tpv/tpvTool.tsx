...
const TpvTool = (props: { productos: Producto[], setShowModalCerrar: Function, setShowModalAbrir: Function }) => {
    ...
    return (
        <div className="overflow-hidden text-gray-800 w-full h-full" onClick={() => { inputRef?.current?.focus() }}>
